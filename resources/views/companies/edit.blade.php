...
<head>
    ...
    <title>{{__('messages.edit-company')}}</title>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">{{__('messages.edit-company')}}</a>
    ...
    @endif
    <form action="{{route('companies.update', $company->id)}}" method="POST" style="margin: 20px" enctype="multipart/form-data">
    @csrf
    @method('put')
