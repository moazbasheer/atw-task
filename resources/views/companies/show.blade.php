...
<head>
    ...
    <title>{{__('messages.show-company')}}</title>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">{{__('messages.show-company')}}</a>
    ...
    @csrf
        ...
        <input type="text" class="form-control" name="website"  value="{{$company->website}}" disabled>
    </form>
</body>
</html>
